  ...
  $(function () {
    ...
    /*-------------------------------------
      ...
      $(document).ready(function() {
        // Fetch the department-wise student count data
        $.getJSON('index.php', function(data) {
          var ctx = $("#earing-line-chart").get(0).getContext("2d");
          var chart = new Chart(ctx, {
            type: 'bar', // Assuming a bar chart is suitable for your data
            data: {
              ...
              datasets: [{
                ...
                backgroundColor: [
                  // Define a color for each department or use a single color
                  'rgba(255, 99, 132, 0.2)',
                  'rgba(54, 162, 235, 0.2)',
                  // Add more colors as needed
                ],
                borderColor: [
                  // Define border colors for each department
                  'rgba(255, 99, 132, 1)',
                  'rgba(54, 162, 235, 1)',
